...
class TourDetailController extends Controller
{
    ...
    {
        // Gọi parent an toàn chỉ khi có constructor
    ...
    public function index($id = 0)
    {
        ...
        // Bảo vệ khi reviewStats null hoặc không có thuộc tính
        if (is_object($reviewStats)) {
        ...
        // Truyền trực tiếp mảng relatedTours
