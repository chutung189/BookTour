...
class SearchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            Log::warning("Invalid end_date format: {$endDate}");
        }

        // an toàn khi lấy tên điểm đến
        $destinationName = $destination ? ($destinationMap[$destination] ?? null) : null;
