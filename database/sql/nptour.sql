...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2025 at 12:16 PM
...
CREATE TABLE `tbl_booking` (
  ...
  `bookingStatus` enum('b','c','y','f') DEFAULT 'b',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(1, 5, 'Thanh Xuan Bac', 'Chu Tùng', '22010841@st.phenikaa-uni.edu.vn', '0912345678', 10, 2, 1, NULL, 23000000, NULL, '', NULL, NULL, NULL),
(2, 5, 'Thanh Xuan Bac', 'Chu Tùng', '22010841@st.phenikaa-uni.edu.vn', '0912345678', 10, 2, 1, NULL, 23000000, NULL, '', NULL, NULL, NULL),
(3, 5, 'Thanh Xuan Bac', 'Chu Tùng', '22010841@st.phenikaa-uni.edu.vn', '0912345678', 10, 2, 1, NULL, 23000000, NULL, 'c', NULL, NULL, NULL),
(4, 5, 'Thanh Tri', 'Pham Viet Phuong', '22010465@st.phenikaa-uni.edu.vn', '0129395483', 13, 2, 1, NULL, 33000000, NULL, '', NULL, NULL, NULL),
(5, 5, 'Thanh Tri', 'Pham Viet Phuong', '22010465@st.phenikaa-uni.edu.vn', '0129395483', 13, 2, 1, NULL, 33000000, NULL, '', NULL, NULL, NULL),
(6, 5, 'Thanh Tri', 'Pham Viet Phuong', '22010465@st.phenikaa-uni.edu.vn', '0912345678', 13, 2, 1, NULL, 33000000, NULL, '', NULL, NULL, NULL),
(7, 5, 'Thanh Tri', 'Pham Viet Phuong', '22010465@st.phenikaa-uni.edu.vn', '0912345678', 13, 2, 1, NULL, 33000000, NULL, '', NULL, NULL, NULL),
(8, 5, 'Thanh Tri', 'Pham Viet Phuong', '22010465@st.phenikaa-uni.edu.vn', '0912345678', 13, 2, 1, NULL, 33000000, NULL, '', NULL, NULL, NULL),
(9, 5, 'Thanh Tri', 'Pham Viet Phuong', '22010465@st.phenikaa-uni.edu.vn', '0912345678', 13, 2, 1, NULL, 33000000, NULL, '', NULL, NULL, NULL),
(10, 5, 'Thanh Xuan Bac', 'Chu Tùng', '22010841@st.phenikaa-uni.edu.vn', '0912345678', 12, 1, 0, NULL, 8000000, NULL, 'y', NULL, NULL, NULL);
...
CREATE TABLE `tbl_checkout` (
  ...
  `paymentStatus` enum('n','y') DEFAULT 'n',
...
INSERT INTO `tbl_checkout` (`checkoutId`, `userId`, `bookingId`, `paymentMethod`, `amount`, `paymentDate`, `paymentStatus`, `transactionId`) VALUES
(1, NULL, 1, 'Cash', 23000000, NULL, '', NULL),
(2, NULL, 1, 'Cash', 23000000, NULL, 'y', NULL),
(3, NULL, 3, NULL, 23000000, NULL, 'n', NULL),
(4, NULL, 5, 'Cash', 33000000, NULL, '', NULL),
(5, NULL, 8, NULL, 33000000, NULL, 'y', NULL),
(6, NULL, 9, 'office-payment', 33000000, NULL, 'y', NULL),
(7, NULL, 10, 'office-payment', 8000000, NULL, 'n', NULL);
...
--
ALTER TABLE `tbl_checkout`
  MODIFY `checkoutId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
